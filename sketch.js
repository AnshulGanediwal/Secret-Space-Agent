...
function draw() {
  ...
  if(gameState === play) {
    ...
    text("The asteroids destroyed Earth!",canvas.width/2-400,canvas.height/2+100);
  ...
  if(gameState === instruction) {
    ...
    text("  You are a secret space agent.",canvas.width/2-300,canvas.height/2-170);
    text("  Help the poor people and Earth !",canvas.width/2-300,canvas.height/2-130);
